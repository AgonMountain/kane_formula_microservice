...
public class EyeToricValidator {
    ...
    public boolean isSiaValid(String sia) {
        boolean isValid = (0 <= Float.parseFloat(sia) && Float.parseFloat(sia) <= 1);
    ...
    public boolean isIncisionValid(String incision) {
        boolean isValid = (0 <= Float.parseFloat(incision) && Float.parseFloat(incision) <= 360);
    ...
    public boolean isK1axisValid(String k1axis) {
        boolean isValid = (0 <= Float.parseFloat(k1axis) && Float.parseFloat(k1axis) <= 180);
